...
try {
  ...
  if (registryPath === DEFAULT_REGISTRY) {
    ...
    const stalePaths = ["AGENTS.md", "README.md", ".template-spec/user-guide/产品生命周期工作流.md", ".template-spec/agents/skill-migrations.md", ".template-spec/process/lifecycle-artifact-map.md"];
